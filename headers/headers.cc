...
EnumParser<SkillType>::EnumParser()
{
    ...
    string2enum["SKILL_LATERAL_DIVE_LEFT"] = SKILL_LATERAL_DIVE_LEFT;
    enum2String[SKILL_LATERAL_DIVE_LEFT] = "SKILL_LATERAL_DIVE_LEFT";

    string2enum["SKILL_LATERAL_DIVE_RIGHT"] = SKILL_LATERAL_DIVE_RIGHT;
    enum2String[SKILL_LATERAL_DIVE_RIGHT] = "SKILL_LATERAL_DIVE_RIGHT";

    string2enum["SKILL_CENTRAL_SPLIT_DIVE"] =  SKILL_CENTRAL_SPLIT_DIVE;
    enum2String[SKILL_CENTRAL_SPLIT_DIVE] = " SKILL_CENTRAL_SPLIT_DIVE";
